...
Examples:
  ./submit_phiper_analysis.sh src/R/02-run_phiper_analysis.R BC-Engl group_test

  ./submit_phiper_analysis.sh src/R/02-run_phiper_analysis.R BC-Engl group_test TRUE FALSE

  ./submit_phiper_analysis.sh src/R/02-run_phiper_analysis.R BC-Engl group_test TRUE FALSE BC-Engl_newlabel.parquet

  ./submit_phiper_analysis.sh src/R/02-run_phiper_analysis.R BC-Engl pre-screening TRUE FALSE BC-Engl.parquet 60G 16 24:00:00
